...
كل أداة في صفحة مستقلة بخطوات مرقّمة: **١ اختر الملفات ← ٢ الإعدادات ← ٣ النتيجة**، وقبل التنزيل جدول يذكر كل ملف ناتج وعدد أسطره وما هو.

| الصفحة | تقابل برنامجك |
|---|---|
| 📥 استيراد كروت مورد وتحويلها | محوّلات الشركات (جيجا، أوزون، ستار، الأهرام، LTT…) |
| 📤 سحب كمية وتصديرها بقالب | `DOJON` |
| ✂️ أخذ كروت من ملف وتقسيمها | `M_L` — تقسيم الكروت |
| ➕ إضافة نص لنهاية كل سطر | `M_L` — تبويب Extintion |
| 🎲 توليد أكواد سرية جديدة | `GEN` |
| 🔖 إضافة سيريال وأكواد لملف أكواد | `SIRIAL v3` |
| 📑 استخراج عمود من ملفات | `EXPORT_SN` |
| 📏 فلترة الأسطر حسب طول الرقم | `LenFilter` |
| 🔀 المطابقة: مطابق وغير مطابق | `MatchFind` |
| 🔍 البحث عن سيريالات داخل ملفات | `serial-sarch` |
| 🧩 دمج ملفات وتوزيعها على الشركات | دمج CSV + تقسيم الكروت |
| ⚙️ الإعدادات والقوالب وحزمة الإعدادات | — |

↩️ الترجيع و🧾 الفواتير والتقارير: مراحل لاحقة.
